...
export const createStyles = (theme: typeof LIGHT_THEME) =>
  StyleSheet.create({
    ...
    projectHeroCard: { backgroundColor: theme.card, borderRadius: 18, borderWidth: 1, borderColor: theme.cardBorder, padding: 16, marginBottom: 16 },
    projectHeroTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
    projectHeroLabel: { color: theme.primary, fontWeight: '700', fontSize: 11, letterSpacing: 0.4, textTransform: 'uppercase' },
    projectHeroTitle: { color: theme.text, fontSize: 22, fontWeight: '700', marginTop: 4 },
    projectHeroMeta: { color: theme.textDim, fontSize: 12, marginTop: 4 },
    projectHeroDesc: { color: theme.text, marginTop: 10 },
    projectHeroActions: { flexDirection: 'row', gap: 10, marginTop: 14 },
    projectStatusPill: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999 },
    projectStatusPillText: { color: 'white', fontWeight: '700', fontSize: 11 },
    inlineCta: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 10 },
    inlineCtaText: { color: theme.primary, fontWeight: '600' },
    nextGoalPill: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 10, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 12, backgroundColor: theme.surface, borderWidth: 1, borderColor: theme.cardBorder },
    nextGoalText: { color: theme.text, fontWeight: '600', fontSize: 12, flex: 1 },
    statsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 16 },
    statCard: { width: '48%', backgroundColor: theme.card, borderRadius: 16, borderWidth: 1, borderColor: theme.cardBorder, padding: 14 },
    statLabel: { color: theme.textDim, fontSize: 11, fontWeight: '700' },
    statValue: { color: theme.text, fontSize: 18, fontWeight: '700', marginTop: 6 },
    statSub: { color: theme.textDim, fontSize: 11, marginTop: 4 },
    budgetCard: { backgroundColor: theme.card, borderRadius: 16, borderWidth: 1, borderColor: theme.cardBorder, padding: 16, marginBottom: 16 },
    ...
    textButtonText: { color: theme.primary, fontWeight: '600', fontSize: 12 },
    ...
    emptyCard: { backgroundColor: theme.card, borderRadius: 16, borderWidth: 1, borderColor: theme.cardBorder, padding: 16, gap: 8 },
    emptyInline: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    emptyLink: { color: theme.primary, fontWeight: '600' },
    budgetBarWrap: { marginTop: 8 },
    budgetBarTrack: { height: 8, borderRadius: 999, backgroundColor: theme.surface, overflow: 'hidden', borderWidth: 1, borderColor: theme.cardBorder },
    budgetBarFill: { height: 8, borderRadius: 999, backgroundColor: theme.primary },
    goalRow: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: theme.card, borderRadius: 14, borderWidth: 1, borderColor: theme.cardBorder, padding: 12, marginBottom: 10 },
    ...
    goalMeta: { color: theme.textDim, fontSize: 12, marginTop: 2 },
    ...
    activeProjectCard: { backgroundColor: theme.card, borderRadius: 18, borderWidth: 1, borderColor: theme.cardBorder, padding: 16, marginBottom: 16 },
    activeProjectLabel: { color: theme.primary, fontWeight: '700', fontSize: 11, letterSpacing: 0.4, textTransform: 'uppercase' },
    activeProjectTopRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
    activeProjectActions: { flexDirection: 'row', gap: 10, marginTop: 10 },
    ...
    secondaryBtn: { backgroundColor: theme.surface, padding: 12, borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: theme.cardBorder },
    primaryBtnSmall: { backgroundColor: theme.primary, paddingVertical: 8, paddingHorizontal: 12, borderRadius: 10, alignItems: 'center' },
    secondaryBtnSmall: { backgroundColor: theme.surface, paddingVertical: 8, paddingHorizontal: 12, borderRadius: 10, alignItems: 'center', borderWidth: 1, borderColor: theme.cardBorder },
